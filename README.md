...
| [`docs/LOGS_OPERATIVOS.md`](./docs/LOGS_OPERATIVOS.md) | **Bitácora del swarm** — schema, protocolo de escritura, catálogo de eventos, escalado |
...
| [`docs/WALKTHROUGH_RESCATE_VISUAL_FASE1.md`](./docs/WALKTHROUGH_RESCATE_VISUAL_FASE1.md) | Bitácora Rescate Visual Fase 1 — Norte/Sureste |
| [`docs/WALKTHROUGH_CONTEXTO_OPERATIVO.md`](./docs/WALKTHROUGH_CONTEXTO_OPERATIVO.md) | Bitácora de sesiones — UI, saneamiento Wyndham, selector de resorts |
